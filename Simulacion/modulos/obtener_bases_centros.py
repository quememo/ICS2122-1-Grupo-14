...
def obtener_centros():
    pandas_centros = pd.read_csv("K:/UC/11 semestre/capstone industrial/Simulacion/datos/centros.csv", sep=";")
...
def obtener_bases():
    pandas_bases = pd.read_csv("K:/UC/11 semestre/capstone industrial/Simulacion/datos/bases.csv", sep=";")
